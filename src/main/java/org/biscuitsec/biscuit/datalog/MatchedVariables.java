...
public final class MatchedVariables implements Serializable {
    ...
    public boolean isComplete() {
        return this.variables.values().stream().allMatch(Optional::isPresent);
    }
    ...
    public Option<Map<Long, Term>> check_expressions(List<Expression> expressions, SymbolTable symbolTable) throws Error {
